...
export function BrandTicker() {
  ...
  return (
    <section className="relative w-full py-16 bg-[#FFFFFF] border-y border-slate-200 overflow-hidden">
      
      {/* Header Eyebrow */}
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-xs font-tech tracking-wider uppercase text-slate-600 font-medium">
            <ShieldCheck className="w-4 h-4 text-accent-primary" />
            <span className="font-bold text-[#0F172A]">Direct Distribution Partner</span>
            <span className="text-slate-300">•</span>
            <span className="text-slate-500">Wholesale Institutional Multi-Brand Supply</span>
          </div>
          <div className="flex items-center gap-2 text-[11px] font-tech text-slate-500">
      ...
      <div className="relative w-full overflow-hidden pause-on-hover">
        {/* Left Fade Mask */}
        <div className="pointer-events-none absolute top-0 bottom-0 left-0 w-24 sm:w-40 bg-gradient-to-r from-white to-transparent z-10" />
        
        {/* Right Fade Mask */}
        <div className="pointer-events-none absolute top-0 bottom-0 right-0 w-24 sm:w-40 bg-gradient-to-l from-white to-transparent z-10" />
        ...
        <div className="animate-marquee-left flex items-center gap-4 py-2.5 mb-3">
          {topLoop.map((brand, idx) => (
            <div
              ...
              className="group relative flex items-center gap-3 px-5 py-3 rounded-2xl border border-slate-200/80 bg-slate-50/70 hover:bg-white hover:border-accent-borderHover hover:shadow-md transition-all duration-300 cursor-default shrink-0"
            >
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  <span className="font-display font-bold text-sm text-[#0F172A] group-hover:text-accent-primary tracking-wider transition-colors">
                    {brand.name}
                  </span>
                  <span className="text-[9px] font-tech text-slate-400 group-hover:text-accent-primary transition-colors">
                    [{brand.origin}]
                  </span>
                </div>
            ...
            >
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-tech text-slate-400 group-hover:text-accent-secondary transition-colors">
                    [{brand.origin}]
                  </span>
                </div>
                <span className="text-[10px] font-tech text-slate-500">
